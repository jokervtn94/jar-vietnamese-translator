...
# Common Chinese words seen in legacy Java activation/payment screens. These are
# diagnostic hints only; presence alone never proves a paywall.
UTF8_HINTS = (
    ...
    def analyze(self, jar_path: str) -> ActivationFlowReport:
        ...
        with zipfile.ZipFile(jar_path, "r") as z:
            for info in z.infolist():
                ...
                # Scan code/resources conservatively. Binary class data is searched only
                # for constant-pool-style ASCII/UTF-8 markers; no decompilation is needed.
